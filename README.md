...
| [docs/](docs/) | [Modelo de dominio](docs/domain-model.md), [contrato de la API](docs/api.md), [despliegue](docs/deployment.md), [notificaciones push](docs/push.md), [datos de demostración](docs/demo.md) y publicar en las tiendas ([App Store](docs/app-store.md), [Google Play](docs/play-store.md)) |
